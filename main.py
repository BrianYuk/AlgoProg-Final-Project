import pygame as pg
import sys
from settings import Settings # (*) doesn't work for some reason, so I manually added the class
from map import Map
...
class Game:
    ...
    def new_game(self): # Starts a new game
        self.map = Map(self)
        ...
        self.sound.load_music("troll_music.mp3", volume=0.3)
